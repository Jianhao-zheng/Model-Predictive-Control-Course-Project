function drawQuadPathTop(sim, Deliverable, Nplots, SaveFile, QuadPlot)

% Plot the trajectory of the quad
figurePath = figure;
set(figurePath,'position',[0 0 1000 500]);
clf; view(2); % 2: top view | 3: orthographic view 
hold on; grid on;
...
if SaveFile
    saveName = Deliverable + "_QuadPathTop";
    print(saveName,'-dpng');
